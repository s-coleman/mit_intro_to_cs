...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    score = 0
    hand_size = calculateHandlen(hand)
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                points = getWordScore(user_input, hand_size)
                score += points
                print('"' + user_input + '"', 'earned', points ,'points. Total:', score,'points')
                print()
                # Update the hand
...
def playGame(wordList):
    ...
    current_hand = ""
    while user_input != "e":
        user_input = input("Enter n to deal a new hand, r to replay the last hand, or e to end game: r: ")
        if user_input not in ['n', 'r', 'e']:
            print("Invalid command.")
        elif rounds == 0 and user_input == "r":
